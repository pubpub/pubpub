import { Collection, SubmissionWorkflow, Pub } from 'server/models';
...
export const updateSubmissionWorkflow = async (inputValues, updatePermissions, actorId?) => {
...
export const destroySubmissionWorkFlow = (inputValues, actorId?) => {
