...
// export const findManyCollections = ({
// 	limit,
// 	offset,
// 	order,
// 	sort,
...
// 				  ]
// 				: []),
// 			...(include.includes('page') ? [{ model: Page, as: 'page' }] : []),
// 		],
// 	}) as Promise<types.DefinitelyHas<Collection, 'community' | 'attributions'>[]>;
// };
