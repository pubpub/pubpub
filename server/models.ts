...
export const ExternalLoginProvider = sequelize.import('./externalLoginProvider/model');
...
export const UserLoginDataExternal = sequelize.import('./userLoginDataExternal/model');
