...
const Html = (props) => {
	const getPath = (chunkName, extension)=> {
		...
		/* needs to change. */
		if (props.initialData.locationData.hostname === 'testing.pubpub.org' || props.initialData.locationData.hostname === 'dev.pubpub.org' || props.initialData.locationData.hostname === 'frankdev.pubpub.org') {
