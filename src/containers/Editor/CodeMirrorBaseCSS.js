...
const blink = Radium.keyframes({
	'0%': {},
	'50%': {backgroundColor: 'transparent'},
	'100%': {},
}, 'blink');

export const CodeMirrorBaseCSS = {
	/* BASICS */
	...
	'.CodeMirror-scrollbar-filler, .CodeMirror-gutter-filler': {
		backgroundColor: 'white', /* The little square between H and V scrollbars */
	},
	...
	'.cm-animate-fat-cursor': {
		width: 'auto',
		border: 0,
		animation: `${blink} steps(1) infinite`,
		backgroundColor: '#7e7',
	},
	...
	'.CodeMirror-lines': {
		...
		cursor: 'text',
		minHeight: '1px', /* prevents collapsing before first draw */
	},
	'.CodeMirror pre': {
		padding: '0 4px', /* Horizontal padding of content */
	...
	'.CodeMirror-scroll, .CodeMirrorSizer, .CodeMirror-gutter, .CodeMirror-gutters, .CodeMirror-linenumber': {
