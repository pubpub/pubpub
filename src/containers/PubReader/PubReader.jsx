			...
			<div style={styles.container}>
				...
				<div style={styles.pubSection}>
					...
					<div className={'pubSectionNav'} style={styles.pubSectionNav}>
						...
						<Link to={'/pub/' + this.props.slug + '/history'} style={globalStyles.link}><div className={'pubNavDate underlineOnHover'} style={styles.pubNavVersion}>Version 29: Nov 12, 2015</div></Link>
