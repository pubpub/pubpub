				...
				<div className={'container narrow'}>
					<div className={'row'}>
						<div className={'col-12'}>
							...
							<p>PubPub reserves the right to change the terms of the Terms of Service ("TOS") or to modify its features at any time.  The Site will post changes to the terms of this User Agreement at {window.location.origin}/tos, and by accessing the Site after modifications to this User Agreement have been posted, you agree to be bound by all the modified terms.</p>
