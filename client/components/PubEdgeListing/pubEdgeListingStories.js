...
const objects = [
	{
		...
		image: 'https://assets.pubpub.org/qsjyoz1y/61586620971745.png',
		...
		relationshipType: RelationshipType.Review,
		pubIsParent: true,
	},
	{
		title: 'Theology in the Shadow of the Corona Crisis',
		contributors: ['Guenter Thomas'],
		image: 'https://assets.pubpub.org/m4ccobdf/51585552700986.jpg',
		...
		relationshipType: RelationshipType.Discussion,
		pubIsParent: true,
	},
	{
		title:
		...
		image: 'https://assets.pubpub.org/dwkdjbj2/11586205211852.jpg',
	...
	},
	{
		...
		image: 'https://assets.pubpub.org/1wuh04pc/41586276667772.jpg',
...
storiesOf('components/PubEdgeListing', module).add('header', () => (
	<StoryContainer>
		<PubEdgeListing accentColor="#A22E37" objects={objects} minimal />
	</StoryContainer>
));
