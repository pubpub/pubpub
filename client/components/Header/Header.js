...
class Header extends Component {
	...
	calculateComponentClasses(hideHero) {
		...
		const backgroundColorChange =
			...
			this.props.communityData.accentColorDark !== this.props.communityData.heroBackgroundColor;
	...
	calculateBackgroundStyle(hideHero) {
		...
		const heroBackgroundColor =
			this.props.communityData.heroBackgroundColor || this.props.communityData.accentColorDark;
