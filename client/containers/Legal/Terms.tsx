	...
	return (
		<div>
			...
			<p>
				...
				be published at{' '}
				<a href={`https://${props.hostname}/legal/aup`}>{`${props.hostname}/legal/aup`}</a>.
			...
			<p>
				...
				contact us at {mailtoHelp}. PubPub may assign or transfer these Terms of Service and
				your agreement thereto upon notice to you. These Terms of Service will be binding
				on, and inure to the benefit of permitted successors and assigns.
			</p>
			<p>
			...
			<p>
				If you have any questions about these Terms of Service, please contact {mailtoHelp}.
			</p>
			<h3>Definitions</h3>
			<p>
