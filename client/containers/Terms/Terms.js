				...
				<div className="legal-wrapper">
					<GridWrapper containerClassName="narrow">
						...
						<ul>
							...
							<li>
								To disseminate or transmit “spam,” unsolicited messages, chain
							...
							<li>
								...
								disrupting other users’ experience of the Site, such as
								intentionally causing a chat screen to scroll faster than other
								users are able to read, or deploying macros with large amounts of
								text for the purpose of disrupting the normal flow of user chats.
							</li>
						</ul>
						<p>
