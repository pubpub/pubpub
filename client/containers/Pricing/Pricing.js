						...
						<div className="col-12">
							...
							<div className="pricing-tiers">
								<div className="option bp3-card bp3-elevation-1">
									...
									<a href="/community/create" className="bp3-button bp3-large bp3-intent-primary">Create your Community</a>
								</div>
								<div className="option bp3-card bp3-elevation-1">
									<h2>Professional</h2>
									...
									<a href="https://mailchi.mp/pubpub/pro" target="_blank" rel="noopener noreferrer" className="bp3-button bp3-large bp3-intent-primary">Join Waiting List</a>
								</div>
								<div className="option bp3-card bp3-elevation-1">
									<h2>Full Service</h2>
									...
									<a href="mailto:team@pubpub.org?subject=Full%20Service%20Inquiry" target="_blank" rel="noopener noreferrer" className="bp3-button bp3-large bp3-intent-primary">Get In Touch</a>
								</div>
							</div>
