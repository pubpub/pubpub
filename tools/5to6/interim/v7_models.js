...
const sequelize = new Sequelize(process.env.V7_PROD_DATABASE_URL, {
	logging: false,
...
const User = sequelize.define('User', {
	...
	gdprConsent: { type: Sequelize.BOOLEAN, defaultValue: null },
});
...
const Branch = sequelize.define('Branch', {
	...
	title: { type: Sequelize.TEXT },
	description: { type: Sequelize.TEXT },
	submissionAlias: { type: Sequelize.TEXT },
	order: { type: Sequelize.DOUBLE },
	publicPermissions: {
		type: Sequelize.ENUM,
	...
	viewHash: { type: Sequelize.STRING },
	discussHash: { type: Sequelize.STRING },
...
const Merge = sequelize.define('Merge', {
	id: id,
	noteContent: { type: Sequelize.JSONB },
	noteText: { type: Sequelize.TEXT },
	/* Set by Associations */
	userId: { type: Sequelize.UUID, allowNull: false },
	pubId: { type: Sequelize.UUID, allowNull: false },
	sourceBranchId: { type: Sequelize.UUID, allowNull: false },
	destinationBranchId: { type: Sequelize.UUID, allowNull: false },
});
const PubVersion = sequelize.define('PubVersion', {
	id: id,
...
const ReviewEvent = sequelize.define('ReviewEvent', {
	...
	userId: { type: Sequelize.UUID, allowNull: false },
	pubId: { type: Sequelize.UUID, allowNull: false },
	reviewId: { type: Sequelize.UUID, allowNull: false },
});
const Review = sequelize.define('Review', {
	...
	/* Set by Associations */
	mergeId: { type: Sequelize.UUID },
	pubId: { type: Sequelize.UUID, allowNull: false },
	sourceBranchId: { type: Sequelize.UUID, allowNull: false },
	destinationBranchId: { type: Sequelize.UUID },
});
const db = {
