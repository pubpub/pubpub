export default {
	...
	title: 'PubPub Dev',
	description: '',
	avatar: 'https://assets.pubpub.org/0xq9swge/11552597813903.jpg',
	favicon: null,
			...
			layout: [
				...
				},
				{
					...
					content: {
						...
						limit: 1,
						title: '',
						pubIds: ['5a635bdc-d71c-40bd-af89-56fdc8b32014'],
					},
				},
				{
					id: 'gu1wh8h8',
											...
											marks: [
												{
													type: 'link',
													attrs: {
														href: 'http://frankenstein.asu.edu/',
														title: null,
														target: null,
													},
												},
											...
											content: [
												{
													...
													content: [
														{
															text: 'Submit your own annotation:',
															type: 'text',
															marks: [
																{
																	type: 'strong',
											...
											marks: [
												{
													type: 'link',
													attrs: {
														href: 'http://csi.asu.edu/books/vvev/',
														title: null,
														target: null,
													},
												},
						...
						text: {
							...
							content: [
								...
								},
								{
									type: 'heading',
									attrs: {
										id: 'title-and-icon-designer',
										level: 3,
									},
									content: [
										{
											text: 'Title and Icon Designer',
											type: 'text',
										},
									],
								},
								...
								},
								{
									...
									content: [
										{
											text: 'Massive Science, massivesci.com',
											type: 'text',
										},
									],
								},
								...
								},
								{
									...
									content: [
										...
										{
											text: 'Stephani Etheridge Woodson',
											type: 'text',
											marks: [
												{
													type: 'link',
						...
						text: {
							...
							content: [
								...
								},
								{
									...
									content: [
										{
											text: 'By accessing content on the ',
											type: 'text',
										},
										{
											text: 'Frankenbook',
								...
								},
								{
									...
									content: [
										...
										{
											text: ' as well as User-Generated Content.',
											type: 'text',
										},
									],
								},
								...
								},
								{
									type: 'heading',
									attrs: {
										id: 'use-of-third-party-content',
										level: 2,
									},
									content: [
										{
											text: 'Use of Third-Party Content',
											type: 'text',
										},
									],
								},
								...
								},
								{
									type: 'heading',
									attrs: {
										id: 'prohibited-uses-of-the-site',
										level: 2,
									},
									content: [
										{
											text: 'Prohibited Uses of the Site',
											type: 'text',
										},
									],
								},
								...
								},
								{
									type: 'heading',
									attrs: {
										id: 'registration-privacy-and-termination-of-access',
										level: 2,
									},
									content: [
										{
								...
								},
								{
									...
									content: [
										...
										{
											text: 'The Site’s Privacy Policy',
											type: 'text',
											marks: [
												{
													type: 'link',
								...
								},
								{
									type: 'heading',
									attrs: {
										id: 'disclaimer-of-warranty--limitation-of-liability',
										level: 2,
									},
									content: [
										{
								...
								},
								{
									type: 'heading',
									attrs: {
										id: 'contacting-this-website',
										level: 2,
									},
									content: [
										{
											text: 'Contacting this Website',
											type: 'text',
										},
									],
								},
								...
								},
								{
									type: 'heading',
									attrs: {
										id: 'effective-date-of-agreement',
										level: 2,
									},
									content: [
										{
								...
								},
								{
									...
									content: [
										{
											text: 'This TOS is in effect as of January 1, 2018.',
											type: 'text',
										},
									],
								},
	...
	admins: [
		...
		{
			id: '2c16502c-d3d6-4cbb-ae0b-7feaabf35a44',
			slug: '-',
			fullName: 'S J',
			initials: 'SJ',
	...
	collections: [
		{
			id: '2140f3c1-f9b1-435b-8b14-8608030071cd',
			title: 'An issue please',
			isPublic: true,
			pageId: null,
			communityId: '0417b0c0-cd38-48bd-8a84-b0b95da98813',
			metadata: {},
			kind: 'issue',
			doi: '10.21428/0417b0c0.2140f3c1',
			readNextPreviewSize: 'choose-best',
			createdAt: '2019-08-02T15:54:12.070Z',
			updatedAt: '2019-08-02T15:54:36.180Z',
		},
		{
			id: '6d83340f-3aea-4e32-8165-6823c4ce513d',
			title: 'aaaa',
			isPublic: true,
			pageId: null,
			communityId: '0417b0c0-cd38-48bd-8a84-b0b95da98813',
			metadata: {},
			kind: 'issue',
			doi: '10.21428/0417b0c0.6d83340f',
			readNextPreviewSize: 'choose-best',
			createdAt: '2019-08-13T19:33:25.202Z',
			updatedAt: '2019-08-13T19:33:32.301Z',
		},
		{
			id: '28084994-c60f-4044-9807-1765cd334ab4',
			title: 'Oooo',
			isPublic: true,
			pageId: '46e12aa2-d09b-42c7-ac50-515ccb60d32f',
			communityId: '0417b0c0-cd38-48bd-8a84-b0b95da98813',
			metadata: {},
			kind: 'book',
			doi: '10.21428/0417b0c0.28084994',
			readNextPreviewSize: 'choose-best',
			createdAt: '2019-08-05T03:03:17.910Z',
			updatedAt: '2019-08-19T15:09:18.097Z',
		},
		{
			id: 'af1f0e57-6fc9-4cdf-9c15-e5e58af59d6b',
			title: 'Essays',
	...
	pubs: [
		{
			id: 'a78cf84f-3a35-4cc9-b431-09fc788880dd',
			slug: 'zzr98k9b',
			title: 'Hello There',
			avatar: null,
			collectionPubs: [],
		...
		{
			id: 'c61a3aa3-8156-4cd3-aacb-223c1b3173a5',
			slug: 'ohoxjbvb',
			title: 'Morem Ipsum',
			avatar: null,
			collectionPubs: [],
		...
		{
			id: '9f113dcb-2191-4273-a823-096753d75d13',
			slug: '944vyvrt',
			title: 'Lorem Ipsum',
			avatar: '',
			collectionPubs: [],
		...
		{
			id: 'fa1465b4-d26c-40c1-86a2-589883e6ef2e',
			slug: 'ptqjgeos',
			title: 'New Pub on Aug 29!',
			avatar: '',
			collectionPubs: [],
			reviews: [],
			attributions: [],
		...
		},
		{
			...
			collectionPubs: [
				{
					id: 'f9206595-b719-4364-a51b-c1d7c6c40c80',
					collectionId: '6d83340f-3aea-4e32-8165-6823c4ce513d',
					pubId: 'be542c24-e383-4eb9-a631-5903caaaa70d',
				},
			],
			reviews: [],
			attributions: [],
		...
		{
			id: '6f97f927-0d89-4333-b2e6-aca6f89e9548',
			slug: 'xiyvipgb',
			title: 'Footnotes Pub?!',
			avatar: null,
			collectionPubs: [],
		...
		{
			id: '12c4d66f-e07c-4783-9674-55c1972a71d2',
			slug: '0y4n70av',
			title: 'New Pub on Aug 14',
			avatar: null,
			collectionPubs: [],
			reviews: [],
			attributions: [],
		...
		{
			id: '1dd03028-68d6-4f49-92ad-dc8d61a6030c',
			slug: 'ytw08zvp',
			title: 'New Pub on Sep 18',
			avatar: null,
			collectionPubs: [],
			reviews: [],
			attributions: [],
		...
		},
		{
			...
			collectionPubs: [
				{
					id: '5f345341-4498-4c19-8baa-4938a0e45463',
					collectionId: '6d83340f-3aea-4e32-8165-6823c4ce513d',
		...
		{
			id: 'e916e827-3d7a-44be-b183-ed07156d24a8',
			slug: 'i7zdhkix',
			title: 'New Pub Hello!',
			avatar: '',
			collectionPubs: [],
		...
		{
			id: '19206c0b-e540-44ef-b382-035044d3488d',
			slug: '36gws2oc',
			title: 'New Pub on Sep 5',
			avatar: null,
			collectionPubs: [],
			reviews: [],
			attributions: [],
		...
		{
			id: 'e334eb75-98ae-4657-8490-7f9e5811872e',
			slug: 'myhfc5p3',
			title: 'New Pub on Sep 5',
			avatar: null,
			collectionPubs: [],
		...
		{
			id: '40b35c11-c3af-41e4-8128-75f3b38c4432',
			slug: 'dllvqkdg',
			title: 'New Pub on Sep 5',
			avatar: null,
			collectionPubs: [],
		...
		{
			id: 'bc9e9863-3bac-4e60-af03-ebc9c689c264',
			slug: '3j735wt5',
		...
		{
			id: 'fc859e4c-da92-45e7-a718-e9da86eb8511',
			slug: 'ey8eyua3',
			title: 'New Pub on Sep 5',
			avatar: null,
			collectionPubs: [],
		...
		{
			id: 'a3bc1904-e021-4e85-81bf-ce4330b0cecc',
			slug: '61qepf6g',
			title: 'New Pub on Sep 6',
			avatar: null,
			collectionPubs: [],
			reviews: [],
			attributions: [],
		...
		{
			id: 'bb717a87-7f7e-495e-afab-c7e3f3bc9a4c',
			slug: 't3xdnwdb',
			title: 'New Pub on Sep 6',
			avatar: null,
			collectionPubs: [],
		...
		{
			id: 'aabbe0ff-630f-4798-87eb-a49e21c39670',
			slug: 'wdraae1b',
			title: 'New Pub on Sep 6',
			avatar: null,
			collectionPubs: [],
		...
		{
			id: 'c488fb92-4e67-437c-b77a-ce6ab2fbd172',
			slug: 'qdxe3g8w',
			title: 'BMJ Hello',
			avatar: null,
			collectionPubs: [],
