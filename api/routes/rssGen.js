		...
		*/
		...
		.then(function(rssCount) {
			...
			if (rssCount < 10 && journal && journal.fbPagesTag) {
				const slugArray = [ 'about', 'privacy', 'hello', 'tos', 'design-as-participation', 'enlightenment-to-entanglement', 'designandscience', 'extended-intelligence', 'dbdb', 'retractions', 'SolarCoin'].slice(0, 10 - rssCount);
